...
$select = $_GET["select"] ?? "*"; // Selecciona las columnas que queramos recibir
$orderBy = $_GET["orderBy"] ?? null;
$orderMode = $_GET["orderMode"] ?? null; // Ordenan las columnas
$startAt = $_GET["startAt"] ?? null;
$endAt = $_GET["endAt"] ?? null; // Limitan la cantidad de datos recibidos
...
if (isset($_GET["linkTo"]) && isset($_GET["equalTo"]) && !isset($_GET["rel"]) && !isset($_GET["type"])) {
	...
	/**
	 * Peticiones GET para seleccion de rangos con tablas relacionadas
	 */
